...
/**
 * The grouped navigation list shared by the persistent desktop sidebar and the
 * mobile drawer. Owns active-state highlighting, feature-flag gating, and the
 * pending badges so both surfaces stay in sync from a single source.
 */
